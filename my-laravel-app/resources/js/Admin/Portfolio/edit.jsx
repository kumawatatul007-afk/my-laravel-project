...
export default function AdminPortfolioEdit({ item }) {
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            ...
                            <input className={`form-input${errors.category ? ' err' : ''}`} value={data.category} onChange={e => setData('category', e.target.value)} />
